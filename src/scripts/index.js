...
import {settings, items, placeForm, profileForm, newPlaceButton, profileEditButton} from './constants.js'
// creating a card
...
const profilePopup = new PopupWithForm({popupSelector: '#popup-edit-profile', handleFormSubmit: data => userinfo.setUserInfo(data)})
...
const placePopup = new PopupWithForm({popupSelector: '#popup-place',  handleFormSubmit: data => cardList.addItem(createCard(data))})
